...
On **iOS**, you should debug from **Safari on OSX** (see online documentation), and on **Android**, you should debug from the **about:debugging** page in **Firefox**, starting from Firefox 70.0 (see online documentation).
