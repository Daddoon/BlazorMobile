...
var blazorMobileRequestValidatorURI;
function blazorMobileRequestValidatorMethod(url, referrer, mustCancel) {
    try {
...
class HookService extends connector_1.Connector {
    ...
    onHostReady() {
        ...
        this.on("add-blazormobile-navigating-behavior", (serviceURI, done) => __awaiter(this, void 0, void 0, function* () {
